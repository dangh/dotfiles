...
set-option -g   @status_left_AA_style "#[#{s|^[^\S]+\\|[^\S]+$||g;s|.+|fg=\\0|:#{T:@status_left_A_fg}} #{s|^[^\S]+\\|[^\S]+$||g;s|.+|bg=\\0|:#{T:@status_left_A_bg}} bold]"
set-option -g   @status_left_ab_symbol_lookup "#{?#{m|r:&#{@status_left_ab_symbol}\s*=,#{@symbols}},"
set-option -ga  @status_left_ab_symbol_lookup   "#{"
set-option -ga  @status_left_ab_symbol_lookup     "s|.*&#{@status_left_ab_symbol}\s*=\s*([^\s]).*|\\1|;"
set-option -ga  @status_left_ab_symbol_lookup     ":@symbols"
set-option -ga  @status_left_ab_symbol_lookup   "},"
set-option -ga  @status_left_ab_symbol_lookup   "#{@status_left_ab_symbol}"
set-option -ga  @status_left_ab_symbol_lookup "}"
set-option -g   @status_left_bc_symbol_lookup "#{?#{m|r:&#{@status_left_bc_symbol}\s*=,#{@symbols}},"
set-option -ga  @status_left_bc_symbol_lookup   "#{"
set-option -ga  @status_left_bc_symbol_lookup     "s|.*&#{@status_left_bc_symbol}\s*=\s*([^\s]).*|\\1|;"
set-option -ga  @status_left_bc_symbol_lookup     ":@symbols"
set-option -ga  @status_left_bc_symbol_lookup   "},"
set-option -ga  @status_left_bc_symbol_lookup   "#{@status_left_bc_symbol}"
set-option -ga  @status_left_bc_symbol_lookup "}"
set-option -g   @status_left_cc_symbol_lookup "#{?#{m|r:&#{@status_left_cc_symbol}\s*=,#{@symbols}},"
set-option -ga  @status_left_cc_symbol_lookup   "#{"
set-option -ga  @status_left_cc_symbol_lookup     "s|.*&#{@status_left_cc_symbol}\s*=\s*([^\s]).*|\\1|;"
...
set-option -ga  @status_right_ZZ_style " #{s|^[^\S]+\\|[^\S]+$||g;s|.+|bg=\\0|:#{T:@status_right_Z_bg}}"
set-option -ga  @status_right_ZZ_style "]"
set-option -g   @status_right_xx_symbol_lookup "#{?#{m|r:&#{@status_right_xx_symbol}\s*=,#{@symbols}},"
set-option -ga  @status_right_xx_symbol_lookup   "#{"
set-option -ga  @status_right_xx_symbol_lookup     "s|.*&#{@status_right_xx_symbol}\s*=\s*([^\s]).*|\\1|;"
set-option -ga  @status_right_xx_symbol_lookup     ":@symbols"
set-option -ga  @status_right_xx_symbol_lookup   "},"
set-option -ga  @status_right_xx_symbol_lookup   "#{@status_right_xx_symbol}"
set-option -ga  @status_right_xx_symbol_lookup "}"
set-option -g   @status_right_xy_symbol_lookup "#{?#{m|r:&#{@status_right_xy_symbol}\s*=,#{@symbols}},"
set-option -ga  @status_right_xy_symbol_lookup   "#{"
set-option -ga  @status_right_xy_symbol_lookup     "s|.*&#{@status_right_xy_symbol}\s*=\s*([^\s]).*|\\1|;"
set-option -ga  @status_right_xy_symbol_lookup     ":@symbols"
set-option -ga  @status_right_xy_symbol_lookup   "},"
set-option -ga  @status_right_xy_symbol_lookup   "#{@status_right_xy_symbol}"
set-option -ga  @status_right_xy_symbol_lookup "}"
set-option -g   @status_right_yz_symbol_lookup "#{?#{m|r:&#{@status_right_yz_symbol}\s*=,#{@symbols}},"
set-option -ga  @status_right_yz_symbol_lookup   "#{"
set-option -ga  @status_right_yz_symbol_lookup     "s|.*&#{@status_right_yz_symbol}\s*=\s*([^\s]).*|\\1|;"
...
set-option -g   @prev_window_status_left_symbol_lookup  "#{?#{m|r:&#{@prev_window_status_left_symbol}\s*=,#{@symbols}},"
set-option -ga  @prev_window_status_left_symbol_lookup    "#{"
set-option -ga  @prev_window_status_left_symbol_lookup      "s|.*&#{@prev_window_status_left_symbol}\s*=\s*([^\s]).*|\\1|;"
...
set-option -ga  @prev_window_status_left_symbol_lookup  "}"
set-option -g   @prev_window_status_right_symbol_lookup "#{?#{m|r:&#{@prev_window_status_right_symbol}\s*=,#{@symbols}},"
set-option -ga  @prev_window_status_right_symbol_lookup   "#{"
set-option -ga  @prev_window_status_right_symbol_lookup     "s|.*&#{@prev_window_status_right_symbol}\s*=\s*([^\s]).*|\\1|;"
...
set-option -ga  @prev_window_status_right_symbol_lookup "}"
set-option -g   @next_window_status_left_symbol_lookup  "#{?#{m|r:&#{@next_window_status_left_symbol}\s*=,#{@symbols}},"
set-option -ga  @next_window_status_left_symbol_lookup    "#{"
set-option -ga  @next_window_status_left_symbol_lookup      "s|.*&#{@next_window_status_left_symbol}\s*=\s*([^\s]).*|\\1|;"
...
set-option -ga  @next_window_status_left_symbol_lookup  "}"
set-option -g   @next_window_status_right_symbol_lookup "#{?#{m|r:&#{@next_window_status_right_symbol}\s*=,#{@symbols}},"
set-option -ga  @next_window_status_right_symbol_lookup   "#{"
set-option -ga  @next_window_status_right_symbol_lookup     "s|.*&#{@next_window_status_right_symbol}\s*=\s*([^\s]).*|\\1|;"
...
set-option -ga  @active_window_status_bg_computed   "}"
set-option -ga  @active_window_status_bg_computed "}"
set-option -g   @active_window_status_left_symbol_lookup  "#{?#{m|r:&#{@active_window_status_left_symbol}\s*=,#{@symbols}},"
set-option -ga  @active_window_status_left_symbol_lookup    "#{"
set-option -ga  @active_window_status_left_symbol_lookup      "s|.*&#{@active_window_status_left_symbol}\s*=\s*([^\s]).*|\\1|;"
...
set-option -ga  @active_window_status_left_symbol_lookup  "}"
set-option -g   @active_window_status_right_symbol_lookup "#{?#{m|r:&#{@active_window_status_right_symbol}\s*=,#{@symbols}},"
set-option -ga  @active_window_status_right_symbol_lookup   "#{"
set-option -ga  @active_window_status_right_symbol_lookup     "s|.*&#{@active_window_status_right_symbol}\s*=\s*([^\s]).*|\\1|;"
...
#: Pane border {{{
set-option -g   @pane_status_left_symbol_lookup  "#{?#{m|r:&#{@pane_status_left_symbol}\s*=,#{@symbols}},"
set-option -ga  @pane_status_left_symbol_lookup    "#{"
set-option -ga  @pane_status_left_symbol_lookup      "s|.*&#{@pane_status_left_symbol}\s*=\s*([^\s]).*|\\1|;"
set-option -ga  @pane_status_left_symbol_lookup      ":@symbols"
set-option -ga  @pane_status_left_symbol_lookup    "},"
set-option -ga  @pane_status_left_symbol_lookup    "#{@pane_status_left_symbol}"
set-option -ga  @pane_status_left_symbol_lookup  "}"
set-option -g   @pane_status_right_symbol_lookup "#{?#{m|r:&#{@pane_status_right_symbol}\s*=,#{@symbols}},"
set-option -ga  @pane_status_right_symbol_lookup   "#{"
set-option -ga  @pane_status_right_symbol_lookup     "s|.*&#{@pane_status_right_symbol}\s*=\s*([^\s]).*|\\1|;"
...
set-option -ga  @pane_status_right_symbol_lookup "}"
set-option -g   @active_pane_status_left_symbol_lookup  "#{?#{m|r:&#{@active_pane_status_left_symbol}\s*=,#{@symbols}},"
set-option -ga  @active_pane_status_left_symbol_lookup    "#{"
set-option -ga  @active_pane_status_left_symbol_lookup      "s|.*&#{@active_pane_status_left_symbol}\s*=\s*([^\s]).*|\\1|;"
...
set-option -ga  @active_pane_status_left_symbol_lookup  "}"
set-option -g   @active_pane_status_right_symbol_lookup "#{?#{m|r:&#{@active_pane_status_right_symbol}\s*=,#{@symbols}},"
set-option -ga  @active_pane_status_right_symbol_lookup   "#{"
set-option -ga  @active_pane_status_right_symbol_lookup     "s|.*&#{@active_pane_status_right_symbol}\s*=\s*([^\s]).*|\\1|;"
