...
#: }}}
#: Formats {{{
set-option -g   @format_xy              "#[#{s|.+|fg=\\0|:#{E:@bg_y}} #{s|.+|bg=\\0|:#{E:@bg_x}} nobold nounderscore noitalics]"
set-option -g   @format_yz              "#[#{s|.+|fg=\\0|:#{E:@bg_z}} #{s|.+|bg=\\0|:#{E:@bg_y}} nobold nounderscore noitalics]"
set-option -g   @format_yZ              "#[#{s|.+|fg=\\0|:#{E:@bg_Z}} #{s|.+|bg=\\0|:#{E:@bg_y}} nobold nounderscore noitalics]"
set-option -g   @format_xz              "#[#{s|.+|fg=\\0|:#{E:@bg_z}} #{s|.+|bg=\\0|:#{E:@bg_x}} nobold nounderscore noitalics]"
set-option -g   @format_xZ              "#[#{s|.+|fg=\\0|:#{E:@bg_Z}} #{s|.+|bg=\\0|:#{E:@bg_x}} nobold nounderscore noitalics]"
set-option -g   @format_xx              "#[#{s|.+|fg=\\0|:#{E:@fg_x}} #{s|.+|bg=\\0|:#{E:@bg_x}}]"
set-option -g   @format_yy              "#[#{s|.+|fg=\\0|:#{E:@fg_y}} #{s|.+|bg=\\0|:#{E:@bg_y}}]"
set-option -g   @format_zz              "#[#{s|.+|fg=\\0|:#{E:@fg_z}} #{s|.+|bg=\\0|:#{E:@bg_z}} bold]"
set-option -g   @format_ZZ              "#[#{s|.+|fg=\\0|:#{E:@fg_Z}} #{s|.+|bg=\\0|:#{E:@bg_Z}} bold]"
