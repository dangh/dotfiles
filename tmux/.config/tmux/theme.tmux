...
#: }}}
#: Formats {{{
set-option -g   @format_win_left        "#[#{s|.+|fg=\\0|:#{E:@bg_win}} nobold nounderscore noitalics]#[push-default]"
set-option -g   @format_win_right       "#[default]"
set-option -g   @format_win_center      "#[#{s|.+|fg=\\0|:#{E:@fg_win}} #{s|.+|bg=\\0|:#{E:@bg_win}}]"
set-option -g   @format_win_left_alt    "#[#{s|.+|fg=\\0|:#{E:@bg_win_alt}} nobold nounderscore noitalics]#[push-default]"
set-option -g   @format_win_right_alt   "#[default]"
set-option -g   @format_win_center_alt  "#[#{s|.+|fg=\\0|:#{E:@fg_win_alt}} #{s|.+|bg=\\0|:#{E:@bg_win_alt}}]"
