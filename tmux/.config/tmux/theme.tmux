...
set-option -wga window-status-format "#{E:@format_win_center} #{E:@window_index_styled}. #{E:@pane_current_path_styled}#{E:@window_zoomed} "
...
set-option -wga window-status-current-format "#{E:@format_cwin_center} #{E:@window_index_styled}. #{E:@pane_current_path_styled}#{E:@window_zoomed} "
