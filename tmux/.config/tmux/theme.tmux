...
#: }}}
#: Formats {{{
set-option -g   @format_ab              "#[#{s|.+|fg=\\0|:#{E:@bg_a}} #{s|.+|bg=\\0|:#{E:@bg_b}} nobold nounderscore noitalics]"
set-option -g   @format_Ab              "#[#{s|.+|fg=\\0|:#{E:@bg_A}} #{s|.+|bg=\\0|:#{E:@bg_b}} nobold nounderscore noitalics]"
set-option -g   @format_bc              "#[#{s|.+|fg=\\0|:#{E:@bg_b}} #{s|.+|bg=\\0|:#{E:@bg_c}} nobold nounderscore noitalics]"
set-option -g   @format_ac              "#[#{s|.+|fg=\\0|:#{E:@bg_a}} #{s|.+|bg=\\0|:#{E:@bg_c}} nobold nounderscore noitalics]"
set-option -g   @format_Ac              "#[#{s|.+|fg=\\0|:#{E:@bg_A}} #{s|.+|bg=\\0|:#{E:@bg_c}} nobold nounderscore noitalics]"
set-option -g   @format_aa              "#[#{s|.+|fg=\\0|:#{E:@fg_a}} #{s|.+|bg=\\0|:#{E:@bg_a}} bold]"
set-option -g   @format_bb              "#[#{s|.+|fg=\\0|:#{E:@fg_b}} #{s|.+|bg=\\0|:#{E:@bg_b}}]"
set-option -g   @format_cc              "#[#{s|.+|fg=\\0|:#{E:@fg_c}} #{s|.+|bg=\\0|:#{E:@bg_c}}]"
set-option -g   @format_AA              "#[#{s|.+|fg=\\0|:#{E:@fg_A}} #{s|.+|bg=\\0|:#{E:@bg_A}} bold]"
