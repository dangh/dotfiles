...
#: Status line {{{
#: Variables {{{
set-option -g   @symbol_ab             "#{?@user_symbol_ab,#{E:@user_symbol_ab},#{E:@theme_symbol_ab}}"
set-option -g   @symbol_bc             "#{?@user_symbol_bc,#{E:@user_symbol_bc},#{E:@theme_symbol_bc}}"
set-option -g   @symbol_cc             "#{?@user_symbol_cc,#{E:@user_symbol_cc},#{E:@theme_symbol_cc}}"
set-option -g   @symbol_xy             "#{?@user_symbol_xy,#{E:@user_symbol_xy},#{E:@theme_symbol_xy}}"
set-option -g   @symbol_yz             "#{?@user_symbol_yz,#{E:@user_symbol_yz},#{E:@theme_symbol_yz}}"
set-option -g   @symbol_xx             "#{?@user_symbol_xx,#{E:@user_symbol_xx},#{E:@theme_symbol_xx}}"
set-option -g   @symbol_cwin_left      "#{?@user_symbol_cwin_left,#{E:@user_symbol_cwin_left},#{E:@theme_symbol_cwin_left}}"
set-option -g   @symbol_cwin_right     "#{?@user_symbol_cwin_right,#{E:@user_symbol_cwin_right},#{E:@theme_symbol_cwin_right}}"
set-option -g   @symbol_win_left       "#{?@user_symbol_win_left,#{E:@user_symbol_win_left},#{E:@theme_symbol_win_left}}"
set-option -g   @symbol_win_right      "#{?@user_symbol_win_right,#{E:@user_symbol_win_right},#{E:@theme_symbol_win_right}}"
...
set-option -g   @format_ZZ              "#[fg=#{E:@fg_Z},bg=#{E:@bg_Z},bold]"
set-option -g   @format_win_left        "#[fg=#{E:@bg_win},bg=#{E:@bg},nobold,nounderscore,noitalics]"
set-option -g   @format_win_right       "#[fg=#{E:@bg_win},bg=#{E:@bg},nobold,nounderscore,noitalics]"
set-option -g   @format_win_center      "#[fg=#{E:@fg_win},bg=#{E:@bg_win}]"
set-option -g   @format_win_left_alt    "#[fg=#{E:@bg_win_alt},bg=#{E:@bg},nobold,nounderscore,noitalics]"
set-option -g   @format_win_right_alt   "#[fg=#{E:@bg_win_alt},bg=#{E:@bg},nobold,nounderscore,noitalics]"
set-option -g   @format_win_center_alt  "#[fg=#{E:@fg_win_alt},bg=#{E:@bg_win_alt}]"
set-option -g   @format_cwin_left       "#[fg=#{E:@bg_cwin},bg=#{E:@bg},nobold,nounderscore,noitalics]"
set-option -g   @format_cwin_right      "#[fg=#{E:@bg_cwin},bg=#{E:@bg},nobold,nounderscore,noitalics]"
set-option -g   @format_cwin_center     "#[fg=#{E:@fg_cwin},bg=#{E:@bg_cwin}]"
set-option -g   @format_cwin_left_alt   "#[fg=#{E:@bg_cwin_alt},bg=#{E:@bg},nobold,nounderscore,noitalics]"
set-option -g   @format_cwin_right_alt  "#[fg=#{E:@bg_cwin_alt},bg=#{E:@bg},nobold,nounderscore,noitalics]"
...
set-option -ga  @window_flags "}"
set-option -g   @window_marked "#{m|r:M,#{window_flags}}"
set-option -g   @window_zoomed "#{m|r:Z,#{window_flags}}"
set-option -g   @window_zoomed_icon "#{?#{E:@window_zoomed},  ,}"
#: }}}
#: Format status line {{{
...
set-option -wga window-status-format "#{?#{E:@window_marked},"
set-option -wga window-status-format   "#{E:@format_win_left_alt}#{E:@symbol_win_left}"
set-option -wga window-status-format   "#{E:@format_win_center_alt} #{E:@window_index_styled}. #{E:@pane_current_path_styled}#{E:@window_zoomed_icon} "
...
set-option -wga window-status-format   "#{E:@format_win_center} #{E:@window_index_styled}. #{E:@pane_current_path_styled}#{E:@window_zoomed_icon} "
set-option -wga window-status-format   "#{E:@format_win_right}#{E:@symbol_win_right}"
set-option -wga window-status-format "}"
set-option -wg  window-status-current-format ""
set-option -wga window-status-current-format "#{?#{E:@window_marked},"
set-option -wga window-status-current-format   "#{E:@format_cwin_left_alt}#{E:@symbol_cwin_left}"
set-option -wga window-status-current-format   "#{E:@format_cwin_center_alt} #{E:@window_index_styled}. #{E:@pane_current_path_styled}#{E:@window_zoomed_icon} "
...
set-option -wga window-status-current-format   "#{E:@format_cwin_center} #{E:@window_index_styled}. #{E:@pane_current_path_styled}#{E:@window_zoomed_icon} "
