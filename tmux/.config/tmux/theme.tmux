...
set-option -wg  @prev_window_status_left_symbol_lookup  "#{?#{m|r:&#{@prev_window_status_left_symbol}\s*=,#{@symbols}},"
set-option -wga @prev_window_status_left_symbol_lookup    "#{"
set-option -wga @prev_window_status_left_symbol_lookup      "s|.*&#{@prev_window_status_left_symbol}\s*=\s*([^\s]).*|\\1|;"
set-option -wga @prev_window_status_left_symbol_lookup      ":@symbols"
set-option -wga @prev_window_status_left_symbol_lookup    "},"
set-option -wga @prev_window_status_left_symbol_lookup    "#{@prev_window_status_left_symbol}"
set-option -wga @prev_window_status_left_symbol_lookup  "}"
set-option -wg  @prev_window_status_right_symbol_lookup "#{?#{m|r:&#{@prev_window_status_right_symbol}\s*=,#{@symbols}},"
set-option -wga @prev_window_status_right_symbol_lookup   "#{"
set-option -wga @prev_window_status_right_symbol_lookup     "s|.*&#{@prev_window_status_right_symbol}\s*=\s*([^\s]).*|\\1|;"
set-option -wga @prev_window_status_right_symbol_lookup     ":@symbols"
set-option -wga @prev_window_status_right_symbol_lookup   "},"
set-option -wga @prev_window_status_right_symbol_lookup   "#{@prev_window_status_right_symbol}"
set-option -wga @prev_window_status_right_symbol_lookup "}"
set-option -wg  @next_window_status_left_symbol_lookup  "#{?#{m|r:&#{@next_window_status_left_symbol}\s*=,#{@symbols}},"
set-option -wga @next_window_status_left_symbol_lookup    "#{"
set-option -wga @next_window_status_left_symbol_lookup      "s|.*&#{@next_window_status_left_symbol}\s*=\s*([^\s]).*|\\1|;"
set-option -wga @next_window_status_left_symbol_lookup      ":@symbols"
set-option -wga @next_window_status_left_symbol_lookup    "},"
set-option -wga @next_window_status_left_symbol_lookup    "#{@next_window_status_left_symbol}"
set-option -wga @next_window_status_left_symbol_lookup  "}"
set-option -wg  @next_window_status_right_symbol_lookup "#{?#{m|r:&#{@next_window_status_right_symbol}\s*=,#{@symbols}},"
set-option -wga @next_window_status_right_symbol_lookup   "#{"
set-option -wga @next_window_status_right_symbol_lookup     "s|.*&#{@next_window_status_right_symbol}\s*=\s*([^\s]).*|\\1|;"
set-option -wga @next_window_status_right_symbol_lookup     ":@symbols"
set-option -wga @next_window_status_right_symbol_lookup   "},"
set-option -wga @next_window_status_right_symbol_lookup   "#{@next_window_status_right_symbol}"
set-option -wga @next_window_status_right_symbol_lookup "}"
set-option -wg  @window_status_left_symbol  "#{?#{@before_active_window},#{T:@prev_window_status_left_symbol_lookup},#{T:@next_window_status_left_symbol_lookup}}"
set-option -wg  @window_status_right_symbol "#{?#{@before_active_window},#{T:@prev_window_status_right_symbol_lookup},#{T:@next_window_status_right_symbol_lookup}}"
set-option -wg  @prev_window_status_left_style  "#{?"
set-option -wga @prev_window_status_left_style    "#{&&:"
set-option -wga @prev_window_status_left_style      "#{@window_status_bg_computed},"
set-option -wga @prev_window_status_left_style      "#{!=:#{@window_status_bg_computed},#{@status_bg}}"
set-option -wga @prev_window_status_left_style    "},"
...
set-option -wga @next_window_status_left_style      "#{@window_status_bg_computed},"
set-option -wga @next_window_status_left_style      "#{!=:#{@window_status_bg_computed},#{@status_bg}}"
set-option -wga @next_window_status_left_style    "},"
...
set-option -wga @active_window_status_bg_computed   "}"
set-option -wga @active_window_status_bg_computed "}"
set-option -wg  @active_window_status_left_symbol_lookup  "#{?#{m|r:&#{@active_window_status_left_symbol}\s*=,#{@symbols}},"
set-option -wga @active_window_status_left_symbol_lookup    "#{"
set-option -wga @active_window_status_left_symbol_lookup      "s|.*&#{@active_window_status_left_symbol}\s*=\s*([^\s]).*|\\1|;"
set-option -wga @active_window_status_left_symbol_lookup      ":@symbols"
set-option -wga @active_window_status_left_symbol_lookup    "},"
set-option -wga @active_window_status_left_symbol_lookup    "#{@active_window_status_left_symbol}"
set-option -wga @active_window_status_left_symbol_lookup  "}"
set-option -wg  @active_window_status_right_symbol_lookup "#{?#{m|r:&#{@active_window_status_right_symbol}\s*=,#{@symbols}},"
set-option -wga @active_window_status_right_symbol_lookup   "#{"
set-option -wga @active_window_status_right_symbol_lookup     "s|.*&#{@active_window_status_right_symbol}\s*=\s*([^\s]).*|\\1|;"
set-option -wga @active_window_status_right_symbol_lookup     ":@symbols"
set-option -wga @active_window_status_right_symbol_lookup   "},"
set-option -wga @active_window_status_right_symbol_lookup   "#{@active_window_status_right_symbol}"
set-option -wga @active_window_status_right_symbol_lookup "}"
set-option -wg  @active_window_status_left_style   "#{?"
set-option -wga @active_window_status_left_style     "#{&&:"
set-option -wga @active_window_status_left_style       "#{@active_window_status_bg_computed},"
set-option -wga @active_window_status_left_style       "#{!=:#{@active_window_status_bg_computed},#{@status_bg}}"
set-option -wga @active_window_status_left_style     "},"
