...
#: }}}
#: Formats {{{
set-option -g   @format_cwin_left       "#[#{s|.+|fg=\\0|:#{E:@bg_cwin}} nobold nounderscore noitalics]#[push-default]"
set-option -g   @format_cwin_right      "#[default]"
set-option -g   @format_cwin_center     "#[#{s|.+|fg=\\0|:#{E:@fg_cwin}} #{s|.+|bg=\\0|:#{E:@bg_cwin}}]"
set-option -g   @format_cwin_left_alt   "#[#{s|.+|fg=\\0|:#{E:@bg_cwin_alt}} nobold nounderscore noitalics]#[push-default]"
set-option -g   @format_cwin_right_alt  "#[default]"
set-option -g   @format_cwin_center_alt "#[#{s|.+|fg=\\0|:#{E:@fg_cwin_alt}} #{s|.+|bg=\\0|:#{E:@bg_cwin_alt}}]"
...
set-option -g   @prev_window_status_left_format  "#{?"
set-option -ga  @prev_window_status_left_format    "#{&&:"
set-option -ga  @prev_window_status_left_format      "#{@window_status_bg_computed},"
set-option -ga  @prev_window_status_left_format      "#{!=:#{@window_status_bg_computed},#{@status_bg}}"
set-option -ga  @prev_window_status_left_format    "},"
set-option -ga  @prev_window_status_left_format    "#[#{s|^[^\\S]+\\|[^\\S]+$||g;s|.+|fg=\\0|:#{T:@window_status_bg_computed}} nobold nounderscore noitalics],"
set-option -ga  @prev_window_status_left_format    "#[#{s|^[^\\S]+\\|[^\\S]+$||g;s|.+|fg=\\0|:#{?@window_status_symbol_fg,#{T:@window_status_symbol_fg},#{T:@window_status_fg_computed}}} nobold nounderscore noitalics]"
set-option -ga  @prev_window_status_left_format  "}#[push-default]"
set-option -g   @prev_window_status_right_format "#[default]"
set-option -g   @next_window_status_left_format  "#{?"
set-option -ga  @next_window_status_left_format    "#{&&:"
set-option -ga  @next_window_status_left_format      "#{@window_status_bg_computed},"
set-option -ga  @next_window_status_left_format      "#{!=:#{@window_status_bg_computed},#{@status_bg}}"
set-option -ga  @next_window_status_left_format    "},"
set-option -ga  @next_window_status_left_format    "#[#{s|^[^\\S]+\\|[^\\S]+$||g;s|.+|fg=\\0|:#{T:@window_status_bg_computed}} nobold nounderscore noitalics],"
set-option -ga  @next_window_status_left_format    "#[#{s|^[^\\S]+\\|[^\\S]+$||g;s|.+|fg=\\0|:#{?@window_status_symbol_fg,#{T:@window_status_symbol_fg},#{T:@window_status_fg_computed}}} nobold nounderscore noitalics]"
set-option -ga  @next_window_status_left_format  "}#[push-default]"
set-option -g   @next_window_status_right_format "#[default]"
set-option -ga  @window_status_left_format   "#{?#{T:@before_active_window},#{T:@prev_window_status_left_format},#{T:@next_window_status_left_format}}"
set-option -ga  @window_status_right_format  "#{?#{T:@before_active_window},#{T:@prev_window_status_right_format},#{T:@next_window_status_right_format}}"
set-option -g   @window_status_center_format "#[#{s|^[^\\S]+\\|[^\\S]+$||g;s|.+|fg=\\0|:#{T:@window_status_fg_computed}} #{s|^[^\\S]+\\|[^\\S]+$||g;s|.+|bg=\\0|:#{T:@window_status_bg_computed}}]"
set-option -wg  window-status-format ""
set-option -wga window-status-format "#{T:@window_status_left_format}"
set-option -wga window-status-format "#{T:@window_status_left_symbol}"
set-option -wga window-status-format "#{T:@window_status_center_format}"
...
set-option -wga window-status-format " "
set-option -wga window-status-format "#{T:@window_status_right_format}"
